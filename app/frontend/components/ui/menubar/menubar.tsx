...
function Menubar({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.Root>) {
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn('flex min-h-12 items-center gap-1 rounded-xs border p-1', className)}
      {...props}
    />
  );
}
...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      {...props}
    >
      <span className="pointer-events-none absolute left-3 flex size-[18px] items-center justify-center [&_svg:not([class*='size-'])]:size-[18px]">
...
function MenubarSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <Icons.chevronRight className="ml-auto size-[18px]" />
    </MenubarPrimitive.SubTrigger>
  );
}
